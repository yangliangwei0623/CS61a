...
class BankAccount:
    ...
    def deposit(self, amount: int) -> int:
        ...
        """
        self.transactions.append(Transaction(self.trans_id,self.balance,self.balance+amount))
        self.trans_id += 1
    ...
    def withdraw(self, amount: int) -> int | str:
        ...
        to the transaction history, and return the new balance.
        """
        after = self.balance if(self.balance - amount < 0) else self.balance - amount
        self.transactions.append(Transaction(self.trans_id,self.balance,after))
        self.trans_id += 1
